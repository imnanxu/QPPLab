...
This step aims to setup initial parameters. Specifically, the following parameters need to be prespecified before runing the script. A parameter file Params_`data`\_`ext`.mat will be generated after running this script.
